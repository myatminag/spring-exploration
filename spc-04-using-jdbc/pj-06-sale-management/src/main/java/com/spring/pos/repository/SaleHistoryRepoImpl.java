...
@Repository
public class SaleHistoryRepoImpl implements SaleHistroyRepo {
	...
	public int create(String salePerson) {
		...
		template.update(insertSql, new MapSqlParameterSource().addValue("salePerson", salePerson), keyHolder,
				new String[] { "id" });
