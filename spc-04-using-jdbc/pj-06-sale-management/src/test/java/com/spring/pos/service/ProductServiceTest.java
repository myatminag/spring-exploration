...
public class ProductServiceTest {
	...
	void test_error_no_code() {
		var exception = assertThrows(PosBusinessException.class, () -> service.findByCode(null));
	...
	void test_error_invalid_code(String code) {
		var exception = assertThrows(PosBusinessException.class, () -> service.findByCode(code));

		assertEquals("Invalid product code!", exception.getMessage());
	}

	@ParameterizedTest
	@CsvSource({ "P0001,Egg L Size,500", "P0002,Egg M Size,400", "P0003,Egg S Size,350", "P0004,Potato Chips,1200",
