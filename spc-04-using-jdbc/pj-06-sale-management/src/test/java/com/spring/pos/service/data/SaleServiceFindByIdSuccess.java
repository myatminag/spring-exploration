...
public class SaleServiceFindByIdSuccess implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		return Stream.of(Arguments.of(1, "Thidar", List.of(new SaleItem("P0001", "Egg L Size", 500, 3))),
				Arguments.of(2, "Nilar",
						List.of(new SaleItem("P0001", "Egg L Size", 500, 2),
								new SaleItem("P0002", "Egg M Size", 400, 2))),
				Arguments.of(3, "Thidar", List.of(new SaleItem("P0002", "Egg M Size", 400, 1),
