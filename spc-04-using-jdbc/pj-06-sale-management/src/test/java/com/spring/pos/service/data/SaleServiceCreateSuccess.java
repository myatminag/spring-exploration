...
public class SaleServiceCreateSuccess implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		return Stream.of(Arguments.of(getCart("Thidar", List.of(new CartItem("P0001", 500, 3))), 1),
				Arguments.of(getCart("Nilar", List.of(new CartItem("P0001", 500, 2), new CartItem("P0002", 400, 2))),
						2),
				Arguments.of(getCart("Thidar", List.of(new CartItem("P0002", 400, 1), new CartItem("P0006", 1500, 4))),
						3));
	}
