...
public class ErrorForSaleItemProvider implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		return Stream.of(emptyProductCode(), invalidProductCode(), zeroQuantity(), zeroUnitPrice());
	}
	...
	private Arguments zeroUnitPrice() {
		...
		return Arguments.of(cart, "Please enter unit price!");
	}
	...
	private Arguments zeroQuantity() {
		...
		return Arguments.of(cart, "Please enter quantity!");
	}
