...
public class DistrictRepoJdbcTemplateTest {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/district_test_find_by_id.txt", delimiter = '\t')
	void test_find_by_id(int id, String name, int divisionId, String divisionName, long townships) {
	...
	@ParameterizedTest
	@CsvSource({ ",,85", "13,,14", ",ma,7", "13,m,4", "13,me,0" })
